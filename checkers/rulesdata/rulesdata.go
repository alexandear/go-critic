	...
	RuleGroups: []ir.RuleGroup{
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           665,
					SyntaxPatterns: []ir.PatternString{{Line: 665, Value: "type $x struct { $*_; sync.Mutex; $*_ }"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "isExported(m[\"x\"])",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 662, Op: ir.FilterStringOp, Src: "`^\\p{Lu}`", Value: "^\\p{Lu}"}},
					},
				},
				{
					Line:           669,
					SyntaxPatterns: []ir.PatternString{{Line: 669, Value: "type $x struct { $*_; *sync.Mutex; $*_ }"}},
					ReportTemplate: "don't embed *sync.Mutex",
					WhereExpr: ir.FilterExpr{
						Line:  670,
						Op:    ir.FilterVarTextMatchesOp,
				...
				{
					Line:           673,
					SyntaxPatterns: []ir.PatternString{{Line: 673, Value: "type $x struct { $*_; sync.RWMutex; $*_ }"}},
				...
				{
					Line:           677,
					SyntaxPatterns: []ir.PatternString{{Line: 677, Value: "type $x struct { $*_; *sync.RWMutex; $*_ }"}},
					ReportTemplate: "don't embed *sync.RWMutex",
					WhereExpr: ir.FilterExpr{
						Line:  678,
						Op:    ir.FilterVarTextMatchesOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            687,
					SyntaxPatterns:  []ir.PatternString{{Line: 687, Value: "$x = sort.IntSlice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"x\"].Type.Is(`[]int`)",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 688, Op: ir.FilterStringOp, Src: "`[]int`", Value: "[]int"}},
					},
				},
				{
					Line:            692,
					SyntaxPatterns:  []ir.PatternString{{Line: 692, Value: "$x = sort.Float64Slice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 693, Op: ir.FilterStringOp, Src: "`[]float64`", Value: "[]float64"}},
					},
				},
				{
					Line:            697,
					SyntaxPatterns:  []ir.PatternString{{Line: 697, Value: "$x = sort.StringSlice($x)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"x\"].Type.Is(`[]string`)",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 698, Op: ir.FilterStringOp, Src: "`[]string`", Value: "[]string"}},
					},
				},
			},
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           708,
				SyntaxPatterns: []ir.PatternString{{Line: 708, Value: "$pkg.$err = $x"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Value: "err",
							Args:  []ir.FilterExpr{{Line: 709, Op: ir.FilterStringOp, Src: "`error`", Value: "error"}},
						},
						{
							Line:  709,
							Op:    ir.FilterVarObjectIsOp,
							Src:   "m[\"pkg\"].Object.Is(`PkgName`)",
							Value: "pkg",
							Args:  []ir.FilterExpr{{Line: 709, Op: ir.FilterStringOp, Src: "`PkgName`", Value: "PkgName"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:           718,
					SyntaxPatterns: []ir.PatternString{{Line: 718, Value: "var()"}},
					ReportTemplate: "empty var() block",
				},
				{
					Line:           719,
					SyntaxPatterns: []ir.PatternString{{Line: 719, Value: "const()"}},
					ReportTemplate: "empty const() block",
				},
				{
					Line:           720,
					SyntaxPatterns: []ir.PatternString{{Line: 720, Value: "type()"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            728,
					SyntaxPatterns:  []ir.PatternString{{Line: 728, Value: "fmt.Errorf($f)"}},
				...
				{
					Line:            733,
					SyntaxPatterns:  []ir.PatternString{{Line: 733, Value: "fmt.Errorf($f($*args))"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            743,
					SyntaxPatterns:  []ir.PatternString{{Line: 743, Value: "strings.Compare($s1, $s2) == 0"}},
				...
				},
				{
					Line: 746,
					SyntaxPatterns: []ir.PatternString{
						{Line: 746, Value: "strings.Compare($s1, $s2) == -1"},
						{Line: 747, Value: "strings.Compare($s1, $s2) < 0"},
					},
					ReportTemplate:  "suggestion: $s1 < $s2",
					SuggestTemplate: "$s1 < $s2",
				},
				{
					Line: 750,
					SyntaxPatterns: []ir.PatternString{
						{Line: 750, Value: "strings.Compare($s1, $s2) == 1"},
						{Line: 751, Value: "strings.Compare($s1, $s2) > 0"},
					},
					ReportTemplate:  "suggestion: $s1 > $s2",
					SuggestTemplate: "$s1 > $s2",
				},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 760,
				SyntaxPatterns: []ir.PatternString{
					{Line: 761, Value: "if $err := $_($*_); $err2 != nil { $*_ }"},
					{Line: 762, Value: "if $err = $_($*_); $err2 != nil { $*_ }"},
					{Line: 763, Value: "if $*_, $err := $_($*_); $err2 != nil { $*_ }"},
					{Line: 764, Value: "if $*_, $err = $_($*_); $err2 != nil { $*_ }"},
				},
				...
				WhereExpr: ir.FilterExpr{
					...
					Args: []ir.FilterExpr{
							...
							Args: []ir.FilterExpr{
								{
									...
									Value: "err",
									Args:  []ir.FilterExpr{{Line: 765, Op: ir.FilterStringOp, Src: "\"error\"", Value: "error"}},
								},
								{
									Line:  765,
									Op:    ir.FilterVarTypeImplementsOp,
						...
						},
						{
							...
							Args: []ir.FilterExpr{
								{Line: 766, Op: ir.FilterVarTextOp, Src: "m[\"err\"].Text", Value: "err"},
								{Line: 766, Op: ir.FilterVarTextOp, Src: "m[\"err2\"].Text", Value: "err2"},
							},
						},
					},
				},
